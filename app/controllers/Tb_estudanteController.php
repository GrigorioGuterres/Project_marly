...
class Tb_estudanteController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				tb_estudante.obs_estudante LIKE ?
			)";
			$search_params = array(
				"%$text%","%$text%","%$text%"
			);
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("naran_estudante","obs_estudante");
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'naran_estudante' => 'required',
				'obs_estudante' => 'required',
			);
			$this->sanitize_array = array(
				'naran_estudante' => 'sanitize_string',
				'obs_estudante' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","naran_estudante","obs_estudante");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'naran_estudante' => 'required',
