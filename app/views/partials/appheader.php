<div id="topbar" class="navbar navbar-expand-md fixed-top navbar-dark" style="background: rgb(115,82,246);
background: -moz-linear-gradient(167deg, rgba(115,82,246,1) 27%, rgba(82,132,246,1) 28%, rgba(84,37,185,1) 68%, rgba(82,151,246,1) 68%);
background: -webkit-linear-gradient(167deg, rgba(115,82,246,1) 27%, rgba(82,132,246,1) 28%, rgba(84,37,185,1) 68%, rgba(82,151,246,1) 68%);
background: linear-gradient(167deg, rgba(115,82,246,1) 27%, rgba(82,132,246,1) 28%, rgba(84,37,185,1) 68%, rgba(82,151,246,1) 68%);
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#7352f6",endColorstr="#5297f6",GradientType=1);">
