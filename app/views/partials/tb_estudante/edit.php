                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-obs_estudante"  value="<?php  echo $data['obs_estudante']; ?>" type="text" placeholder="Enter Obs Estudante"  required="" name="obs_estudante"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
