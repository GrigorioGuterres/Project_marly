            ...
            <div class="container">
                <div class="row ">
                        ...
                        <div class="">
                            <div class="fadeIn animated mb-4">
                                <div class="text-capitalize">
                                    <h2 class="text-capitalize"><center> SISTEMA INFORMATIKA GESTAUN VISITANTES IHA FATIN HISTÓRIKU   ARQUIVU MUSSEU RESSISTENSIA TIMORENSE IHA DILI </center> <hr></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 comp-grid">
                        ...
                        <div  class="p-3 animated flash page-content" style="background: rgb(100,210,236);
